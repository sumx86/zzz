    ...
    <div id='main-container'>
        <div id='navbar'>
            ...
            <?php
                if(!$isLogin) {
                    ...
                    <span>".$language_config[$lang]['sign-in']."</span>
                </div>";
                }
            ?>
        </div>
        ...
        <div id='search-game-container'>
            ...
            <form id='search-form' action='' method=''>
                <input id='search-game' type='text' name='search-game' placeholder='<?php echo $language_config[$lang]['search']; ?>'>
            </form>
            <div id='mid'>
        ...
        <div id='collection-redirect-container'>
